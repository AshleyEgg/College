...
* @param screen The Screen to draw onto.
* @param circle The Circle to draw.
* @details To draw a circle, you will reuse Bresenham's Circle Drawing algorithm
*          as mentioned above.
*
*          Note that the algorithm for drawCircle draws pixels in pairs that
*          have the same x value but different y values. These are grouped and
*          split with empty lines in the pseudocode for your convenience.
*
*          For this function, all you have to do is to replace the each pair of
*          "plot" calls in the pseudocode with a single call to drawLine that
*          draws a line between the two points in the pair that are plotted.
*
*          So overall, instead of just drawing the paired pixels, you draw a
*          a line between them, it's fairly simple!
*/
