# -*- coding: utf-8 -*-
"""Project_5_Part_2_Instructions.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15p1QqXi6PBsegGDVdRB9AkvxZGqyQTMt
...
class LaneFinder:
  ...
  def compute_orientation(self, image):
    ...
    Z_in_camera_frame_list = [z/math.cos(self.camera_pitch) for z in self.scan_lines]
  ...
  def find_lane_boundaries_on_scan_line(self, image, v):
    ...
    mid_point = int(len(intensities)/2)
    for x in range(mid_point):
      if intensities[mid_point - x] > 230 and u_left == 0:
        u_left = mid_point - x
      if intensities[mid_point + x] > 230 and u_right == 0:
        u_right = mid_point + x
  ...
  def compute_angle_of_lane_with_optical_axis(self, lane_line):
    ...
    orientation = math.atan(lane_line[0] / lane_line[2])
...
#########################################################################
image_path = '/content/drive/My Drive/saved_images'
#########################################################################
#                             END OF YOUR CODE                          
#########################################################################
...
Z_cm = [20, 35]
camera_pitch_deg = 17
focal_length_in_pixels = 311.05
height_of_camera_cm = 10.5
v0 = 240
u0 = 320
DEBUG = True
