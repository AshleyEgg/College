...
craft = sphere(pos=vector(-67200000,1472000,0), radius=1.0e6, color=color.yellow)
vcraft = vector(179,2515,0)
...
while t < 65040:
    ...
    Force_craftMoon = -(G*mcraft*mMoon)/(mag(r_craftMoon)**2)*norm(r_craftMoon)#Force on Moon due to spacecraft
