...
public class Conditionals {
    ...
    public static void main(String[] args) {
        ...
        Scanner keyboard = new Scanner(System.in);//gets input from the keyboard but must import it at the top
        int num = keyboard.nextInt();

        String favorites = (num % 2) ? "Tech" : "UGA";//Ternary expressions- will make favorites Tech if num is even and UGA if num is odd
        ...
        if (3 == 4)
            System.out.println("woohoo. I love 3s");
